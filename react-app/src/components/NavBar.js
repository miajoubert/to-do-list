        ...
        <div className='nav-bar-left'>
          <div className='nav-bar-item nav-link'>
            <svg width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor" fill-rule="evenodd" d="M4.5 5h15a.5.5 0 1 1 0 1h-15a.5.5 0 0 1 0-1zm0 6h15a.5.5 0 1 1 0 1h-15a.5.5 0 1 1 0-1zm0 6h15a.5.5 0 1 1 0 1h-15a.5.5 0 1 1 0-1z"></path>
            </svg>
          </div>
          ...
          <div className='nav-bar-item search' >
            <NavLink to='/search' exact={true}
              className="nav-link"
              activeClassName='active'>
              <svg width="24" height="24" viewBox="0 0 24 24" className="search-icon">
